...
class MinerUApp:
    ...
    def _build_ui(self):
        ...
        self.file_tree.heading("序号", text="#", anchor=CENTER, width=40)
        self.file_tree.heading("文件名", text="文件名")
        self.file_tree.heading("大小", text="大小", anchor=E, width=100)
        self.file_tree.heading("状态", text="状态", anchor=CENTER, width=100)
        self.file_tree.column("序号", width=40, anchor=CENTER)
